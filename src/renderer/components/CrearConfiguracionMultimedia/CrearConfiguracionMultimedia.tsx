    ...
    return (
        <div>
          ...
          <label htmlFor="video-upload" className="drop-container"
            ...
            <span className="drop-title">Arrastre un video aqui</span>
            o
            <input type="file" id="video-upload"  accept='.mp4, .mov, .avi, .mkv, .webm, .wmv' required />
          </label>
          <section className="display-center">
            <h3>Imagen:</h3>
          </section>
          <label htmlFor="file-upload" className="drop-container"
            ...
            onDragEnter={e => handleDragEnter(e)}
            onDragLeave={e => handleDragLeave(e)} >
            <span className="drop-title">Arrastre una imagen aqui</span>
            o
